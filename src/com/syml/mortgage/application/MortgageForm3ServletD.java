...
public class MortgageForm3ServletD extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		Logger log = LoggerFactory.getLogger(MortgageForm3ServletD.class);
			...
			if(property1 != null && property1.equalsIgnoreCase("yes")){
				...
				if(additionalYesNo1.equalsIgnoreCase("no")){
					...
					if(mortgageYesNo1 != null && mortgageYesNo1.equalsIgnoreCase("yes") && sellingYesNo1 != null && sellingYesNo1.equalsIgnoreCase("yes")){
						...
						dataStoreValue.put("address1",address1);
						dataStoreValue.put("propertyconter",propertyconter);
						dataStoreValue.put("sellingYesNo1",sellingYesNo1);
					//	dataStoreValue.put("FormType",formType);
						...
						if(condoYesNo1 != null && condoYesNo1.equalsIgnoreCase("yes")){
							...
							dataStoreValue.put("condoFees1",condoFees1);
						...
						if(rentalYesNo1 !=null && rentalYesNo1.equalsIgnoreCase("no")){
							...
							dataStoreValue.put("address1",address1);
							dataStoreValue.put("sellingYesNo1",sellingYesNo1);
							dataStoreValue.put("rentalYesNo1",rentalYesNo1);

							//dataStoreValue.put("FormType",formType);
							dataStoreValue.put("SubForm",subForm);
							//dataStoreValue.put("ip", ip);
							storeData=new CouchBaseOperation();
							storeData.appendDataInCouchBase(form1UniqueId1, dataStoreValue);
							if(condoYesNo1 != null && condoYesNo1.equalsIgnoreCase("yes")){
								log.debug("condo values set to yes");
								createLead.createApplicantProperties(applicantID, address1, condoFees1,propertyconter,sellingYesNo1);
								log.debug("CouchBase");
						...
						if(rentalYesNo1 != null && rentalYesNo1.equalsIgnoreCase("no")){
							...
							dataStoreValue.put("address1",address1);
							dataStoreValue.put("propertyconter",condoFees1);
							dataStoreValue.put("sellingYesNo1",sellingYesNo1);
							...
							dataStoreValue.put("address1",address1);
							dataStoreValue.put("propertyconter",propertyconter11);
							dataStoreValue.put("sellingYesNo1",sellingYesNo1);
					...
					if(additionalYesNo2 !=null && additionalYesNo2.equalsIgnoreCase("no")){
						...
						while(iterate.hasNext()){
							...
							if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
								...
								dataStoreValue.put("address"+i,address);
								dataStoreValue.put("sellingYesNo"+i,sellingYesNo);
								...
								if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
									...
									dataStoreValue.put("condoFees"+i,condofee);
								...
								if(rentalYesNo2 != null && rentalYesNo2.equalsIgnoreCase("no")){
									...
									if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
										...
										dataStoreValue.put("condoFees"+i,condoFees2);
									}else{
										log.debug("condo values set to no");
										createLead.createApplicantProperties(applicantID, address, "-1",propertyconter,sellingYesNo);
								...
								if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
									...
									dataStoreValue.put("address"+i,address);
									dataStoreValue.put("sellingYesNo"+i,sellingYesNo);
									dataStoreValue.put("condofee"+i,condofee);
								...
								if(rentalYesNo.equalsIgnoreCase("no") && rentalYesNo != null){
									createLead.createApplicantMortgage(applicantID, address,propertyconter, sellingYesNo1);
									log.debug("CouchBase");
								

									dataStoreValue.put("address"+i,address);
									dataStoreValue.put("sellingYesNo"+i,sellingYesNo1);
									...
									if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
										...
										dataStoreValue.put("condofee"+i,condoFees1);
						...
						if(additionalYesNo3 !=null && additionalYesNo3.equalsIgnoreCase("no")){
							...
							while(iterate.hasNext()){
								...
								if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
									...
									dataStoreValue.put("address"+j,address);
									dataStoreValue.put("propertyconter"+j,propertyconter);


									dataStoreValue.put("sellingYesNo"+j,sellingYesNo);
									...
									if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
										...
										dataStoreValue.put("condofee"+j,condofee);
									...
									if(rentalYesNo3.equalsIgnoreCase("no") && rentalYesNo3 != null){
										...
										dataStoreValue.put("sellingYesNo"+j,sellingYesNo1);
										...
										if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
											...
											dataStoreValue.put("address1",address);

											dataStoreValue.put("sellingYesNo1",sellingYesNo);
											dataStoreValue.put("condofee",condoFees1);
								...
								while(iterate.hasNext()){
									...
									if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
										...
										if(condoYesNo != null && condoYesNo.equalsIgnoreCase("yes")){
											...
											dataStoreValue.put("condofee",condofee);
