...
public class MortgageApplicationCoServlet2 extends HttpServlet {

	
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		Logger log = LoggerFactory.getLogger(MortgageApplicationCoServlet2.class);
		...
		String subForm ="Mortgage Co-Application 2";
...
try{
	...
	String currentAddress=req.getParameter("whatis26"); 
...
// TODO: handle exception
	...
	if(currentAddress != null){
		...
		dataStoreValue.put("CoApplicant-currentAddress",currentAddress);
		dataStoreValue.put("CoApplicant-currentYear",currentYear);
		dataStoreValue.put("CoApplicant-currentMonths",currentMonths);
		dataStoreValue.put("CoApplicant-currentSumMonth",currentSumMonth);
		dataStoreValue.put("CoApplicant-totalcurrentMonths",totalcurrentMonths);
	...
	if((totalcurrentMonths != null && totalcurrentMonths.length()!=0 && !totalcurrentMonths.equals(""))&& totalcurrentMonthsInt<=36){
		...
		if(currentAddress != null && priorAddress1 != null){
			...
			if(currentAddressSplit != null){
				...
				log.debug("Applicant created with priorAddress1 ");

				//append data To couchBase
				log.debug("CouchBase data is appending..");
			

				dataStoreValue.put("CoApplicant-priorAddress1",priorAddress1);
				dataStoreValue.put("CoApplicant-priorYear1",priorYear1);
				dataStoreValue.put("CoApplicant-priorMonths1",priorMonths1);
				dataStoreValue.put("CoApplicant-priorSumMonth1",priorSumMonth1);
				dataStoreValue.put("CoApplicant-totalpriorcurrentmonths1",totalpriorcurrentmonths1);
		...
		String priorAddress2=req.getParameter("whatwas54"); 
		...
		if(totalpriorcurrentmonths2Int<=36 && (totalpriorcurrentmonths2!=null && !totalpriorcurrentmonths2.equals(""))){
			...
			if(priorAddress2 != null){
				...
				if(currentAddressSplit != null){
					...
					dataStoreValue.put("CoApplicant-priorAddress2",priorAddress2);
					dataStoreValue.put("CoApplicant-priorYear2",priorYear2);
					dataStoreValue.put("CoApplicant-priorMonths2",priorMonths2);
					dataStoreValue.put("CoApplicant-priorSumMonth2",priorSumMonth2);
					dataStoreValue.put("CoApplicant-totalpriorcurrentmonths2",totalpriorcurrentmonths2);
			...
			String priorAddress3=req.getParameter("whatwas"); 
			...
			if(currentAddress != null && priorAddress1 != null && priorAddress2 != null && priorAddress3 != null){
				...
				if(currentAddressSplit != null){
					...
					dataStoreValue.put("CoApplicant-priorAddress3",priorAddress3);
					dataStoreValue.put("CoApplicant-priorAddress3",priorYear3);
					dataStoreValue.put("CoApplicant-priorMonths3",priorMonths3);
					dataStoreValue.put("CoApplicant-priorSumMonth3",priorSumMonth3);
					dataStoreValue.put("CoApplicant-totalpriorcurrentmonths3",totalpriorcurrentmonths3);
	...
	dataStoreValue.put("CoApplicant-subForm2",subForm);
...
storeData.appendDataInCouchBase("Applicant_"+applicantIDone, dataStoreValue);
	...
	req.setAttribute("uniid",uniid);
     		...
     		req.getRequestDispatcher("MortgageApplicationCo3.jsp").include(req, res);
			
			//res.sendRedirect("http://form.jotformpro.com/form/50334188310952?unniid="+form1UniqueId1+"&applicantID"+applicantID);
