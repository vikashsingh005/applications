...
public class MortgageApplicationCoServlet3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		Logger log = LoggerFactory.getLogger(MortgageApplicationCoServlet3.class);
		...
		try{
			...
			dataStoreValue.put("CoApplicant-subForm3",subForm);

			//get the session attribute
			HttpSession ses1=req.getSession(true);
			String form1UniqueId1=(String)ses1.getAttribute("form1uniqueId");
			String applicantID=(String)ses1.getAttribute("applicantId2");
			...
			String property1=req.getParameter("doesthe134");  //Property1
			...
			if(property1 != null && property1.equalsIgnoreCase("yes")){
				...
				if(additionalYesNo1.equalsIgnoreCase("no")){
					...
					dataStoreValue.put("CoApplicant-address1",address1);
					dataStoreValue.put("CoApplicant-mortgageYesNo1",mortgageYesNo1);
					dataStoreValue.put("CoApplicant-rentalYesNo1",rentalYesNo1);
					dataStoreValue.put("CoApplicant-additionalYesNo1",additionalYesNo1);
					
					
					dataStoreValue.put("CoApplicant-sellingYesNo1",sellingYesNo1);
					dataStoreValue.put("CoApplicant-condoYesNo1",condoYesNo1);
					dataStoreValue.put("CoApplicant-condoFees1",condoFees1);
					...
					if(mortgageYesNo1 != null && mortgageYesNo1.equalsIgnoreCase("yes") && sellingYesNo1 != null && sellingYesNo1.equalsIgnoreCase("yes")){
						...
						dataStoreValue.put("CoApplicant-propertyconter",propertyconter);
						...
						log.debug("CouchBase");
							...
							createLead.createApplicantMortgageRental(applicantID, address1,propertyconter2, sellingYesNo1,"1");
							
							log.debug("calling income for rental");
							
							
							createLead.createIncomeApplicantRental(applicantID,9,address1,"Landlord","12",false,true ,propertyconter2);
							
							log.debug("CouchBase");
										if(condoYesNo1 != null && condoYesNo1.equalsIgnoreCase("yes")){
								log.debug("condo values set to yes");
								createLead.createApplicantProperties(applicantID, address1, condoFees1,propertyconter2,sellingYesNo1);
								log.debug("CouchBase");
								}else{
								log.debug("condo values set to no");
								createLead.createApplicantProperties(applicantID, address1, "-1",propertyconter2,sellingYesNo1);
								log.debug("CouchBase");
					...
					if(additionalYesNo2 !=null && additionalYesNo2.equalsIgnoreCase("no")){
						...
						while(iterate.hasNext()){
							...
							dataStoreValue.put("CoApplicant-address"+i,address);
							dataStoreValue.put("CoApplicant-mortgageYesNo"+i,mortgageYesNo);
							dataStoreValue.put("CoApplicant-rentalYesNo"+i,rentalYesNo);
							dataStoreValue.put("CoApplicant-additionalYesNo",additionalYesNo2);
							
							
							dataStoreValue.put("CoApplicant-sellingYesNo"+i,sellingYesNo);
							dataStoreValue.put("CoApplicant-condoYesNo"+i,condoYesNo);
							dataStoreValue.put("CoApplicant-condoFees"+i,condofee);
							...
							if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
								...
								log.debug("CouchBase");
									...
									createLead.createIncomeApplicantRental(applicantID,9,address2,"Landlord","12",false,true,propertyconter );
								...
								log.debug("CouchBase");
									...
									createLead.createIncomeApplicantRental(applicantID,9,address2,"Landlord","12",false,true ,propertyconter2);
											if(condoYesNo1 != null && condoYesNo1.equalsIgnoreCase("yes")){
							...
							while(iterate.hasNext()){
								...
								if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
									...
									createLead.createApplicantMortgage(applicantID, address,propertyconter, sellingYesNo);
										...
										createLead.createIncomeApplicantRental(applicantID, 9, address3, "Landlord","12", false, true,propertyconter2);
										
										if(condoYesNo != null && condoYesNo1.equalsIgnoreCase("yes")){
											log.debug("condo values set to yes");
											createLead.createApplicantProperties(applicantID, address, condofee,propertyconter2,sellingYesNo);
													}else{
											log.debug("condo values set to no");
											createLead.createApplicantProperties(applicantID, address, "-1",propertyconter2,sellingYesNo);
											log.debug("CouchBase");
							...
							if(additionalYesNo4 !=null && additionalYesNo4.equalsIgnoreCase("no")){
								...
								while(iterate.hasNext()){
									...
									if(rentalYesNo4.equalsIgnoreCase("no") && rentalYesNo4!=null){										
										...
										createLead.createApplicantMortgageRental(applicantID,address,propertyconter2, sellingYesNo, "1");
										log.debug("calling rental income");
										...
										log.debug("CouchBase");
											...
											createLead.createApplicantMortgageRental(applicantID, address,propertyconter1, sellingYesNo, "1");
											log.debug("Logic for Rental Else block");
											log.debug("CouchBase");
											log.debug("calling rental income");
											
											createLead.createIncomeApplicantRental(applicantID,9,address2,"Landlord","12",false,true ,propertyconter1);
																if(condoYesNo1 != null && condoYesNo1.equalsIgnoreCase("yes")){
												log.debug("condo values set to yes");
												createLead.createApplicantProperties(applicantID, address, condoFees1,propertyconter1,sellingYesNo);
												log.debug("CouchBase");
													}else{
												log.debug("condo values set to no");
												createLead.createApplicantProperties(applicantID, address, "-1",propertyconter1,sellingYesNo);
												log.debug("CouchBase");
									...
									while(iterate.hasNext()){
										...
										if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
											...
											log.debug("CouchBase");
												...
												createLead.createApplicantMortgageRental(applicantID, address,propertyconter1, sellingYesNo1,"1");
												...
												createLead.createIncomeApplicantRental("applicantID",9,address2,"Landlord","12",false,true,propertyconter1 );
														...
														if(condoYesNo != null && condoYesNo1.equalsIgnoreCase("yes")){
													log.debug("condo values set to yes");
													createLead.createApplicantProperties(applicantID, address, condofee,propertyconter1,sellingYesNo);
													log.debug("CouchBase");
															}else{
													log.debug("condo values set to no");
													createLead.createApplicantProperties(applicantID, address, "-1",propertyconter1,sellingYesNo);
									...
									while(iterate.hasNext()){
										...
										if(mortgageYesNo != null && mortgageYesNo.equalsIgnoreCase("yes") && sellingYesNo != null && sellingYesNo.equalsIgnoreCase("yes")){
											...
											if(rentalYesNo6.equalsIgnoreCase("no") && rentalYesNo6!=null){
												...
												createLead.createIncomeApplicantRental(applicantID,9,address,"Landlord","12",false,true,propertyconter1 );
			...
			String applicantIDone=(String) ses1
		...
		storeData.appendDataInCouchBase("Applicant_"+applicantIDone, dataStoreValue);
			...
			req.getRequestDispatcher("MortgageApplicationCo4.jsp").include(req, res);
			}else{
